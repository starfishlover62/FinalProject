    ...
    : mPlayerName(playerName), mScore(initialScore), mLevel(0), mFont(loadFont())
{
    ...
    initializeText(mGameOverText, 400, 360, "GAME OVER", 36, sf::Color::Red);
    initializeText(mRetryText, 390, 420, "Retry? (Y or N)", 36, sf::Color::White);
